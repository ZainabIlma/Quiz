 ...
 * @author sunway
 */
public class l2sq5 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBounds(530, 100, 180, 90);
   ...
   timer.scheduleAtFixedRate(task, 1000, 1000);  // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(l2sq3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
