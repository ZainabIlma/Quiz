 ...
 * @author sunway
 */
public class l3tq3 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText(" 'DTP' computer abbreviation usually means ?");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(10, 0, 880, 40);

        buttonGroup1.add(r1);
        r1.setFont(new java.awt.Font("URW Palladio L", 3, 24)); // NOI18N
        r1.setForeground(new java.awt.Color(54, 44, 215));
        r1.setText("Digital Transmission Protocol");
